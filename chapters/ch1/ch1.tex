...
In ambito operativo, ciò si realizza attraverso configurazioni settoriali che evolvono nel corso della giornata. Ogni configurazione è costituita da una combinazione di settori attivi (cfr.\ \S\S~\ref{subsec:settore-elementare} e~\ref{subsec:settore-collassato}), selezionati secondo un opening scheme che ne determina la temporizzazione. A ciascun settore attivo è associata una capacità nominale, definita come il numero massimo di voli che possono essere gestiti per unità di tempo, determinata sulla base della complessità operativa e delle risorse disponibili.
