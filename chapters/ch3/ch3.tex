...
\item \textbf{Profili di volo (cfr.\ §§~\ref{sec:flight_points} e~\ref{sec:flight_airspace})}: i profili \textit{filed} derivano direttamente dai piani di volo presentati al \gls{nm}, mentre i profili \textit{actual} sono ottenuti tramite osservazioni radar e messaggi \gls{atfcm} gestiti dal \gls{nm}.
\end{itemize}
