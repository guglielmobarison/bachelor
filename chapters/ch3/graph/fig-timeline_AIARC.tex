...
\draw[cyanline] (SDOentryStart) -- (SDOentryEnd)
  node[pos=0, anchor=east, xshift=-2pt, text=cyan, align=center]{\acrshort{sdo} Data Entry \\\& Validation};
...
\draw[greenline2] (AIRACnode) -- ($(T0) + (0,\levelsep*3)$)
  node[pos=0, anchor=east, xshift=-2pt, text=cyan, align=center]{\acrshort{sdo} \gls{airac}\\Data Published};
...
\draw[greenline2] (nonAIRACnode) -- ($(T0) + (0,\levelsep*4)$)
  node[pos=0, anchor=east, xshift=-2pt, text=cyan, align=center]{SDO non-\gls{airac}\\Data Published};
\node[diamond, draw=green!70!black, fill=green!70!black, minimum size=6pt, inner sep=0pt]
     at (nonAIRACnode) {};
...
\draw[yellowline] (NOTAMstart) -- (NOTAMend)
  node[midway, above, yshift=2pt, text=orange!90!yellow]{\acrshort{notam}};
...
\draw[greenline2] (CACDstart) -- (CACDmid)
    node[midway, above, yshift=2pt, text=orange!90!yellow]{\acrshort{cacd} Published}
;

\draw[yellowline] (CACDmid) -- (CACDend)
    node[midway, above, yshift=2pt, text=orange!90!yellow]{\acrshort{cacd} Pre-OPS}   
;
...
\draw[greenline2] (ASMstart) -- (ASMquarter)
     node[midway, above, yshift=2pt, text=orange!90!yellow]{Level 1}
     node[pos=0, anchor=east, xshift=-2pt, text=cyan, align=center]{\gls{asm} Data};
\draw[yellowline2] (ASMquarter) -- (ASMmid)
     node[midway, above, yshift=2pt, text=orange!90!yellow]{Level 2};
\draw[orangeline] (ASMmid) -- (ASMend)
    node[midway, above, yshift=2pt, text=orange!90!yellow]{Level 3};
...
\draw[greenline2] (ASMstart) -- (ASMquarter)
     node[midway, above, yshift=2pt, text=orange!90!yellow]{Strategic}
     node[pos=0, anchor=east, xshift=-2pt, text=cyan, align=center]{\gls{atfcm} Data};
\draw[yellowline2] (ASMquarter) -- (ASMmid)
     node[midway, above, yshift=2pt, text=orange!90!yellow]{Pre-Tactical};
\draw[orangeline] (ASMmid) -- (ASMend)
    node[midway, above, yshift=2pt, text=orange!90!yellow]{Tactical};
...
\draw[cyanline2] (start) -- (Interp)
    node[midway, above, yshift=2pt, text=orange!90!yellow]{\textbf{Design}};

\draw[greenline2] (Interp) -- ($ (D6) + (0,\levelsep*9)$)
    node[midway, above, yshift=2pt, text=orange!90!yellow]{\textbf{Strategic}};
;

\draw[yellowline2] ($ (D6) + (0,\levelsep*9)$) -- ($ (T2) + (0,\levelsep*9)$)
    node[midway, above, yshift=2pt, text=orange!90!yellow]{\textbf{Pre-Tactical}};


\draw[orangeline] ($ (T2) + (0,\levelsep*9)$) -- ($ (T0) + (0,\levelsep*9)$)
    node[midway, above, yshift=2pt, text=orange!90!yellow]{\textbf{Tactical}};
