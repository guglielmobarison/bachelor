...
\begin{tabularx}{\textwidth}{!{\vrule}c!{\vrule}X!{\vrule}}
    ...
    \textbf{88} & \textbf{Implementazione delle procedure di esportazione}  \\ \hdashline 
    \multirow{4}{0cm}\\ 
    \textit{72} & 
    ...
    \textbf{40} & \textbf{Test di performance dei modelli \gls{dac}}  \\ \hdashline 
    \multirow{4}{0cm}\\ 
    \textit{20} & 
	...
	\textbf{20} & \textbf{Realizzazione di un'interfaccia utente}  \\ 
    \hline   
    ...
    \hline \hline
    \textbf{\textit{320}} & \multicolumn{1}{|l|}{\textbf{\textit{Totale ore}}} \\\hline
\end{tabularx}
    \caption{Distribuzione pianificata delle ore di lavoro per attività, secondo il preventivo iniziale.}
    \label{tab:pianificazione-attivita}
\end{table}