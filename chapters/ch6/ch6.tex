...
\textit{O02} & Acquisizione dei dati \gls{adrr}. & Raggiunto \\
\textit{O03} & Implementazione di procedure di esportazione dei dati \gls{adrr} nei formati richiesti dai modelli di ottimizzazione per \gls{dac}. & Raggiunto \\
...
\hline
\textit{F01} & Implementazione di un'interfaccia utente per l'esecuzione delle procedure di importazione ed esportazione dei dati.\gls{adrr} & Non raggiunto \\
\hline
\end{tabularx}
