...
Muovendosi dal quadro definitorio introdotto (cfr.\ Cap.~\ref{ch:introduzione-contesto}) e dagli obiettivi operativi (cfr.\ Cap.~\ref{ch:obiettivi-pianificazione}), questo capitolo assume come fonte primaria le tabelle sui profili di attraversamento delle regioni d’informazione volo, con particolare riferimento alla sottosezione \textsc{FLIGHT AIRSPACES} (cfr.\ Cap.~\ref{ch:caratteristiche-adr}, \S\ref{sec:flight_airspace}) e ai collegamenti semantici con \textsc{FLIGHTS} (cfr.\ \S\ref{sec:flights}).
